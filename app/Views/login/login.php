                        ...
                        <div class="row">
                            <div class="col-lg">
                                <div class="p-4">
                                    ...
                                    <hr style="background-color: #00A859; margin-bottom: 0;">
                                    <small style="color: yellow;">Klik daftar jika belum punya akun</small>
                                    <div class="text-right">
                                        <a class="text-light" href="<?= base_url('login/daftar') ?>">Daftar?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
