            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/pesanan') ?>" class="nav-link active">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fa-solid fa-cart-arrow-down"></i> Pesanan</h3>
                    </div>
                    <div class="card" style="margin-bottom: 70px;">
                        <div class="card-header">
                            <h5 class="card-title m-0">Tabel Data Pesanan</h5>
                                ...
                                <tbody>
                                    ...
                                    foreach ($pesanan as $psn) { ?>
                                        <tr>
                                            ...
                                            <td><a href="https://www.google.com/maps/dir//<?= $psn['koordinat'] ?>" target="_blank"><i class="fa-solid fa-map-location-dot text-danger"></i></i></a></td>
                                            <td><?= $psn['alamat'] ?></td>
                                            <td><?= $psn['alamat_lengkap'] ?></td>
                                            <td><?= $psn['qty'] ?></td>
                                            <td><?= $psn['total'] ?></td>
                                            <td><?= $psn['status'] ?></td>
                                            <td>
                                                <form action="<?= base_url() ?>/admin/hapus_pesanan/<?= $psn['id_checkout'] ?>" method="post">
                                                    <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $psn['id_checkout'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $psn['id_checkout'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/edit_pesanan/' . $psn['id_checkout']) ?>">
                                                            <?= csrf_field(); ?>
                                                            <div class="form-group">
                                                                <label>Status</label>
                                                                <input type="text" class="form-control" name="status" value="<?= $psn['status'] ?>" required>
                                                            </div>
