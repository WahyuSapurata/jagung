                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/gambar1') ?>" class="nav-link active">
                            ...
                            <table id="example1" class="table table-bordered table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    foreach ($gambar as $gbr) { ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            <td><img src="<?= base_url('uploads/gambar1/' . $gbr['gambar']) ?>" width="100" alt=""></td>
                                            <td>
                                                <form action="<?= base_url() ?>/admin/hapus_gambar1/<?= $gbr['id_gambar'] ?>" method="post">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/edit_gambar1/' . $gbr['id_gambar']) ?>">
                                                            <?= csrf_field(); ?>
                                                            ...
                                                            <img src="<?= base_url('uploads/gambar1/' . $gbr['gambar']) ?>" width="100" alt="" id="foto" class="mb-3">
