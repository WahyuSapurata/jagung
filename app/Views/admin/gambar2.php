                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/gambar2') ?>" class="nav-link active">
                                        <i class="nav-icon fa-solid fa-image"></i>
                                        <p>Gambar 2</p>
                                    </a>
                                </li>
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fa-solid fa-image"></i> Gambar 1</h3>
                    </div>
                    <div class="card" style="margin-bottom: 70px;">
                        <div class="card-header">
                            <h5 class="card-title m-0">Tabel Data Gambar 1</h5>
                            ...
                            <table id="example1" class="table table-bordered table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    foreach ($gambar as $gbr) { ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            <td><img src="<?= base_url('uploads/gambar2/' . $gbr['gambar']) ?>" width="100" alt=""></td>
                                            <td>
                                                <!-- <form action="<?= base_url() ?>/admin/hapus_gambar2/<?= $gbr['id_gambar'] ?>" method="post"> -->
                                                <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $gbr['id_gambar'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $gbr['id_gambar'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/edit_gambar2/' . $gbr['id_gambar']) ?>">
                                                            <?= csrf_field(); ?>
                                                            <input type="hidden" name="lama" value="<?= $gbr['gambar'] ?>">
                                                            <div class="form-group">
                                                                <label>Foto</label>
                                                                <input type="file" id="file_upload" class="custom" name="file_upload" value="<?= $gbr['gambar'] ?>" onchange="gambar(this.value)">
                                                            </div>
                                                            <img src="<?= base_url('uploads/gambar2/' . $gbr['gambar']) ?>" id="foto" width="100" alt="" class="mb-3 img-preview">
