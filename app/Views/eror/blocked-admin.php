...
<body>
    ...
    <b:if cond='data:view.isError'>
        <div class='errorWrap'>
            ...
            <a class='homepage' title='Dzuhalah' href='<?= base_url('login/index') ?>'>Kembali Ke Login</a>
            <p style="margin-top: 10px;">&copy; Copyright <strong><?= NAMA_APLIKASI ?></strong>. All Rights Reserved</p>
        </div>
    </b:if>
