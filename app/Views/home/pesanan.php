    ...
    <section>
        <div class="container d-flex user">
            <div class="user-sidebar">
                <div class="user-item">
                    <div class="item1">
                        <a href="<?= base_url('home/user') ?>"><i class="fa-solid fa-user text-success me-2"></i> <span class="user-text1">Akun Saya</span></a>
                    </div>
                    <div class="item2">
                        <a href="<?= base_url('home/pesanan') ?>"><i class="fa-solid fa-clipboard-list text-info me-2"></i> <span class="active user-text2">Pesanan Saya</span></a>
                    </div>
                </div>
            </div>
            <div class="user-content">
                <div class="user-body">
                    <h3>
                        <strong>Semua Pesanan Saya</strong>
                    </h3>
                    <hr>
                    <div style="display: grid; gap: 10px;">
                        <?php if ($jagung == null) { ?>
                            <i class="fa-solid fa-ban" style="text-align: center; font-size: 55px; opacity: 0.5;"></i>
                            <h2 style="text-align: center; padding: 0 21px; opacity: 0.5;">Belum ada pesanan</h2>
                        <?php } else { ?>
                            <?php foreach ($jagung as $jgn) { ?>
                                <div class="kerangjang-belanja" style="border: 2px solid #78b785; border-radius: 3px;">
                                    <div class="item-kerangjang">
                                        <div class="col-md-6">
                                            <div class="item-gambar">
                                                <div class="qazx">
                                                    <img style="height: 15vh; width: 140px; border-radius: 5px;" src="<?= base_url('uploads/jagung/' . $jgn['foto_jagung']) ?>" alt="">
                                                </div>
                                                <div class="qwerty">
                                                    <h6 style="font-weight: bold;"><?= $jgn['judul'] ?></h6>
                                                    <small>Total Harga</small>
                                                    <h4 class="harga-checkout"><?= $jgn['total'] ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="harga-keranjang">
                                                <a href="<?= base_url('home/detail_pesanan/' . $jgn['id_checkout']) ?>" class="btn btn-keranjang">Detail Pesanan</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
