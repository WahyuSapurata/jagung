    ...
    <section class="produk">
        <div class="container">
            ...
            <?php if ($hasil == null) { ?>
                ...
                <h2 style="text-align: center; padding: 0 21px; opacity: 0.5;">Tidak ada data pecarian untuk <?= $cari ?></h2>
            <?php } else { ?>
                <h6 style="text-align: center; margin-top: 10px;">Hasil pencarian dari kata '<?= $cari ?>'</h6>
                <div class="body-kategori">
                    <?php foreach ($hasil as $jgn) { ?>
