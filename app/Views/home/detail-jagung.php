...
<head>
    ...
    <?php foreach ($kategori as $ktg) { ?>
        <title><?= NAMA_APLIKASI . ' - ' . $ktg['jenis_kategori'] ?></title>
    <?php } ?>
    ...
    <template id="header-bar">
        ...
        <div class="container">
            <div class="navbar-header d-flex">
                ...
                <strong class="text-header">Detail Jagung</strong>
            </div>
        </div>
    </template>
        ...
        <div class="container pt-2 pb-2">
            ...
            <div class="navbar-collapse d-flex" id="navbarSupportedContent">
                <a class="navbar-brand d-flex" href="<?= base_url('home/beranda') ?>">
                    ...
                    <h4 class="image-bar" style="line-height: 48px; color: #033e23;">Detail Jagung</h4>
                </a>
        ...
        <div class="container">
            <div class="row-produk">
                <div class="header-produk">
                    <h4 class="m-0 title">
                        <?php foreach ($kategori as $ktg) { ?>
                            Jenis-jenis <?= $ktg['jenis_kategori'] ?>
                        <?php } ?>
                    </h4>
                </div>
            </div>
            <div class="body-kategori">
                <?php foreach ($dJagung as $djg) { ?>
                    <a href="<?= base_url('home/belanja/' . $djg['id_jagung']) ?>" title="<?= $djg['judul'] ?>">
                        <div class="card card-ikon-kategori ">
                            <img class="card-img-top" style="height: auto; margin-bottom: 5px;" src="<?= base_url('uploads/jagung/' . $djg['foto_jagung']) ?>" alt="">
                            <div class="card-body">
                                <h6 class="card-title m-0"><?= $djg['judul'] ?></h6>
                                <div class="detail-harga">
                                    <div class="harga"><?= buatRupiah($djg['harga']) ?></div>
